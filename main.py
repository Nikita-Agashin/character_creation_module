...
def attack(char_name: str, char_class: str) -> str:
    """Функция рассчита нанесённого удара."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция рассчёта блокированного удара."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция рассчита силы специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция описания класса и тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор имени персонажа и класса."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    """Главная функция, принимающая на вход имя персонажа."""
